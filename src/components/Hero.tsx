...
export default function Hero() {
  return (
    ...
    >
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_18%,rgba(255,211,0,0.34),transparent_30%),radial-gradient(circle_at_78%_50%,rgba(180,0,0,0.12),transparent_34%),radial-gradient(circle_at_15%_75%,rgba(255,190,0,0.18),transparent_34%)]" />
      ...
      <div className="relative mx-auto grid max-w-7xl items-center gap-10 md:grid-cols-[1fr_0.9fr]">
        ...
        <div className="relative mx-auto hidden max-w-md items-center justify-center md:flex">
          <div className="absolute h-[28rem] w-[28rem] rounded-full bg-yellow-300/45 blur-3xl" />
